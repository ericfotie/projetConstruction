    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-slate-950">
            ...
            <div className="text-center mb-16 relative z-10 max-w-2xl px-4">
                <Motion variant="fadeInUp" duration="slow" delay={0}>
                    <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-6">
                        Tiger <span className="text-blue-400">Construction</span>
                    </h1>
                </Motion>
                <Motion variant="fadeIn" duration="slow" delay={200}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl relative z-10">
                ...
                <Motion variant="slideLeft" duration="slow" delay={100}>
                    <Link
                        to="/client"
                        className="group bg-white/5 border border-white/10 backdrop-blur-md rounded-[2.5rem] p-8 hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] block"
                    >
                ...
                <Motion variant="slideRight" duration="slow" delay={250}>
                    <Link
                        to="/admin/messages"
                        className="group bg-white/5 border border-white/10 backdrop-blur-md rounded-[2.5rem] p-8 hover:bg-white/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] block"
                    >
